                        ...
                        flexWrap: 'wrap', fontFamily: "'DM Mono', monospace", fontSize: 12,
                            ...
                            const getFixSteps = (row) => {
                                ...
                                if (os.includes('android'))
                                    return { title: 'Android enrollment — general steps', matched: false, steps: [
                                ...
                                if (os.includes('ios') || os.includes('ipad'))
                                    return { title: 'iOS/iPadOS enrollment — general steps', matched: false, steps: [
                                ...
                                if (os.includes('windows'))
                                    return { title: 'Windows enrollment — general steps', matched: false, steps: [
                                ...
                                if (os.includes('mac'))
                                    return { title: 'macOS enrollment — general steps', matched: false, steps: [
