...
import { api, copyRunbook, getAuthStatus, getView, refreshData, deviceSync, deviceReboot, deviceAutopilotReset, deviceBulkAction, deviceRetire, deviceWipe, deviceCollectDiagnostics, deviceRotateBitLockerKeys, deviceResetPasscode, getExportUrl, getIncidentWorkflows, saveIncidentWorkflow } from './api/client.js';
...
function EfmWalkthrough({ onSignIn }) {
    ...
    const s = steps[step];
    return (_jsxs("div", { className: "efm-walkthrough", children: [_jsxs("div", { className: "efm-wt-left", children: [_jsx("div", { className: "efm-wt-badge", children: s.icon }), _jsx("h2", { className: "efm-wt-heading", children: s.title }), _jsx("p", { className: "efm-wt-desc", children: s.desc }), _jsx("div", { className: "efm-wt-stats", children: s.stats.map((st, i) => (_jsxs("div", { className: "efm-wt-stat", children: [_jsx("div", { className: "efm-wt-stat-val", style: { color: st.color }, children: st.value }), _jsx("div", { className: "efm-wt-stat-lbl", children: st.label })] }, i))) }), _jsx("div", { className: "efm-wt-tabs", children: steps.map((_, i) => (_jsx("button", { className: "efm-wt-tab" + (i === step ? " active" : ""), onClick: () => setStep(i), children: steps[i].icon }, i))) }), _jsxs("div", { className: "efm-wt-nav", children: [_jsx("button", { className: "efm-wt-nav-btn", onClick: () => setStep(Math.max(0, step - 1)), disabled: step === 0, children: "\u2190 Prev" }), _jsx("div", { className: "efm-wt-dots", children: steps.map((_, i) => _jsx("div", { className: "efm-wt-dot" + (i === step ? " active" : ""), onClick: () => setStep(i) }, i)) }), step < steps.length - 1
                                ? _jsx("button", { className: "efm-wt-nav-btn", onClick: () => setStep(step + 1), children: "Next \u2192" })
                                : _jsx("button", { className: "btn btn-primary welcome-signin-btn", style: { padding: '6px 18px', fontSize: 12 }, onClick: onSignIn, children: "\uD83D\uDD11 Get started" })] }), _jsxs("div", { style: { marginTop: 16 }, children: [_jsx("button", { className: "btn btn-primary welcome-signin-btn", style: { marginTop: 24, width: '100%' }, onClick: onSignIn, children: "\uD83D\uDD11 Connect your Intune tenant" }), _jsx("div", { style: { textAlign: 'center', marginTop: 10, fontSize: 11, color: 'var(--text-dim)' }, children: "30-day free trial \u00B7 No credit card required \u00B7 $5/month after trial" })] })] }), _jsxs("div", { className: "efm-wt-right", children: [_jsxs("div", { className: "efm-wt-mock-topbar", children: [_jsx("span", { style: { fontSize: 11, fontWeight: 700, color: 'var(--amber)' }, children: "\u26A1 Enrollment Flow Monitor" }), _jsx("span", { className: "efm-wt-mock-pill", children: "\u25CF Live" })] }), _jsx("div", { className: "efm-wt-mock-rows", children: s.rows.map((r, i) => (_jsxs("div", { className: "efm-wt-mock-row", children: [_jsxs("div", { children: [_jsx("div", { style: { fontSize: 12, fontWeight: 600, color: 'var(--text)' }, children: r.name }), _jsx("div", { style: { fontSize: 10, color: 'var(--text-dim)' }, children: r.sub })] }), _jsx("span", { className: "efm-wt-badge-pill " + r.cls, children: r.status })] }, i))) })] })] }));
}
...
function EnrollmentFailuresView({ efRows, efLoading, efError, efSearch, setEfSearch, efOsFilter, setEfOsFilter, selectedEfRow, setSelectedEfRow, efRetrying, setEfRetrying, auth, api, addToast, setEfRows, setEfLoading, setEfError, ERROR_CATALOG }) {
    ...
    return (_jsxs("div", { style: { display: 'flex', gap: 16, alignItems: 'flex-start' }, children: [_jsxs("div", { className: "error-catalog-shell", style: { flex: 1, minWidth: 0 }, children: [_jsxs("div", { className: "error-catalog-header", children: [_jsxs("div", { children: [_jsx("div", { className: "error-catalog-title", children: "\u26D4 Enrollment Failures" }), _jsx("div", { className: "error-catalog-subtitle", children: "Live from Intune via Graph API \u00B7 click a row to act" })] }), _jsx("button", { className: "btn btn-secondary", style: { fontSize: 12 }, onClick: () => {
                                ...
                                if (!osMatch)
                                    return null;
                                return (_jsxs("button", { className: "btn btn-secondary", style: { width: '100%', justifyContent: 'flex-start', gap: 8, fontSize: 11, padding: '7px 10px', border: action.danger ? '1px solid rgba(239,68,68,.25)' : undefined }, disabled: !selectedEfRow.deviceId || efRetrying || !auth.hasWritePermissions, title: action.desc, onClick: async () => {
...
Proceed?`))
                                        ...
                                        setEfRetrying(true);
                                        try {
                                            const res = await api.post(`/devices/${selectedEfRow.deviceId}/${action.endpoint}`);
                                    ...
                                    }, children: [_jsx("span", { children: action.icon }), _jsx("span", { style: { flex: 1 }, children: efRetrying ? 'Sending…' : action.label }), action.danger && _jsx("span", { style: { fontSize: 9, color: 'var(--red)', fontWeight: 700 }, children: "DANGER" }), action.os && _jsx("span", { style: { fontSize: 9, color: 'var(--text-dim)', fontFamily: 'monospace' }, children: action.os })] }, action.endpoint));
                            })] }), _jsxs("div", { style: { borderTop: '1px solid var(--border)', paddingTop: 12, display: 'flex', flexDirection: 'column', gap: 8 }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' }, children: [_jsx("div", { style: { fontSize: 9, fontWeight: 700, color: 'var(--text-dim)', textTransform: 'uppercase', letterSpacing: '.08em' }, children: "Fix Steps" }), _jsx("span", { style: { fontSize: 9, background: fix.matched ? 'rgba(16,185,129,.15)' : 'var(--amber-dim)', color: fix.matched ? 'var(--green)' : 'var(--amber)', borderRadius: 4, padding: '1px 6px', fontWeight: 700 }, children: fix.matched ? 'CATALOG MATCH' : 'GENERIC' })] }), _jsx("div", { style: { fontSize: 11, fontWeight: 600, color: 'var(--text)' }, children: fix.title }), _jsx("ol", { style: { paddingLeft: 16, display: 'flex', flexDirection: 'column', gap: 6 }, children: fix.steps.map((step, i) => (_jsx("li", { style: { fontSize: 11, color: 'var(--text-dim)', lineHeight: 1.5 }, children: step }, i))) })] })] }))] }));
}
// ── GraphExplorerView ─────────────────────────────────────────────────────────
const GQ_TEMPLATES = [
...
// ── ComplianceDriftView ───────────────────────────────────────────────────────
function ComplianceDriftView({ snapshots, loading, api, addToast, setSnapshots, setLoading }) {
    const refresh = () => {
        setLoading(true);
        api.get('/graph/compliance-drift').then((res) => {
    ...
    return (_jsxs("div", { className: "error-catalog-shell", children: [_jsxs("div", { className: "error-catalog-header", children: [_jsxs("div", { children: [_jsx("div", { className: "error-catalog-title", children: "\uD83D\uDCC9 Compliance Drift" }), _jsx("div", { className: "error-catalog-subtitle", children: "Compliance state tracked over time \u2014 snapshot taken on each refresh" })] }), _jsx("button", { className: "btn btn-secondary", style: { fontSize: 12 }, onClick: refresh, children: "\u21BA Take Snapshot" })] }), loading ? (_jsxs("div", { children: [_jsx("div", { className: "skeleton" }), _jsx("div", { className: "skeleton" }), _jsx("div", { className: "skeleton" })] })) : snapshots.length === 0 ? (_jsxs("div", { className: "empty-state", children: [_jsx("div", { className: "empty-state-title", children: "No snapshots yet" }), _jsx("div", { className: "empty-state-desc", children: "Click \"Take Snapshot\" to record your current compliance state. Each refresh adds a new data point to track drift over time." }), _jsx("button", { className: "btn btn-primary", style: { marginTop: 12 }, onClick: refresh, children: "\uD83D\uDCF8 Take First Snapshot" })] })) : (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: 16 }, children: [_jsx("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 10 }, children: [
                            ...
                            { label: 'Snapshots', value: snapshots.length, color: 'var(--teal)', sub: 'Data points collected' },
                        ].map(c => (_jsxs("div", { style: { background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 8, padding: 12 }, children: [_jsx("div", { style: { fontSize: 10, color: 'var(--text-dim)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '.06em', marginBottom: 5 }, children: c.label }), _jsx("div", { style: { fontSize: 20, fontWeight: 700, color: c.color }, children: String(c.value) }), _jsx("div", { style: { fontSize: 10, color: 'var(--text-dim)', marginTop: 2 }, children: c.sub })] }, c.label))) }), _jsxs("div", { style: { background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 8, padding: 16 }, children: [_jsx("div", { style: { fontSize: 13, fontWeight: 700, color: 'var(--text)', marginBottom: 12 }, children: "Compliance Over Time" }), _jsx("div", { style: { overflowX: 'auto' }, children: _jsxs("svg", { width: Math.max(600, snapshots.length * 70), height: 180, style: { display: 'block' }, children: [snapshots.map((s, i) => {
                                            const x = i * 70 + 35;
                                            ...
                                            return (_jsxs("g", { children: [_jsx("rect", { x: x - 20, y: barY, width: 40, height: barH, fill: col, fillOpacity: 0.8, rx: 3 }), _jsxs("text", { x: x, y: barY - 5, textAnchor: "middle", fill: col, fontSize: 10, fontWeight: 700, children: [rate, "%"] }), _jsx("text", { x: x, y: 168, textAnchor: "middle", fill: "#4A6080", fontSize: 9, children: new Date(s.timestamp).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit' }) })] }, i));
                                        }), _jsx("line", { x1: 0, y1: 150, x2: Math.max(600, snapshots.length * 70), y2: 150, stroke: "#263850", strokeWidth: 1 })] }) })] }), _jsxs("div", { style: { background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 8, padding: 16 }, children: [_jsx("div", { style: { fontSize: 13, fontWeight: 700, color: 'var(--text)', marginBottom: 10 }, children: "Snapshot History" }), _jsxs("table", { style: { width: '100%', borderCollapse: 'collapse', fontSize: 11 }, children: [_jsx("thead", { children: _jsx("tr", { style: { borderBottom: '2px solid var(--border)' }, children: ['Date', 'Compliant', 'Non-Compliant', 'Unknown', 'Total', 'Rate'].map(h => (_jsx("th", { style: { padding: '6px 10px', textAlign: 'left', color: 'var(--text-dim)', fontSize: 9, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '.06em' }, children: h }, h))) }) }), _jsx("tbody", { children: [...snapshots].reverse().map((s, i) => {
                                            const rate = Math.round((s.compliant / Math.max(s.total, 1)) * 100);
                                            return (_jsxs("tr", { style: { borderBottom: '1px solid var(--border)' }, children: [_jsx("td", { style: { padding: '7px 10px', color: 'var(--text-dim)', fontSize: 10 }, children: new Date(s.timestamp).toLocaleString() }), _jsx("td", { style: { padding: '7px 10px', color: 'var(--green)', fontWeight: 700 }, children: s.compliant }), _jsx("td", { style: { padding: '7px 10px', color: 'var(--red)', fontWeight: 700 }, children: s.noncompliant }), _jsx("td", { style: { padding: '7px 10px', color: 'var(--amber)', fontWeight: 700 }, children: s.unknown }), _jsx("td", { style: { padding: '7px 10px', color: 'var(--text)' }, children: s.total }), _jsx("td", { style: { padding: '7px 10px' }, children: _jsxs("span", { style: { fontSize: 11, padding: '2px 8px', borderRadius: 4, fontWeight: 700, background: rate >= 90 ? 'rgba(16,185,129,.12)' : rate >= 70 ? 'rgba(245,158,11,.12)' : 'rgba(239,68,68,.12)', color: rate >= 90 ? 'var(--green)' : rate >= 70 ? 'var(--amber)' : 'var(--red)' }, children: [rate, "%"] }) })] }, i));
                                        }) })] })] })] }))] }));
}
// ── EnrollmentPolicyView ──────────────────────────────────────────────────────
function EnrollmentPolicyView({ epData, epLoading, epError, api, setEpData, setEpLoading, setEpError, addToast, runbookText, setRunbookText, runbookLoading, setRunbookLoading }) {
    const refresh = () => {
        setEpLoading(true);
        setEpError('');
        api.get('/graph/enrollment-policy').then((res) => {
            setEpData(res.data);
    ...
    const stateColor = (state) => {
        if (state === 'enrolled')
            return { bg: 'rgba(16,185,129,.12)', color: 'var(--green)' };
        if (state === 'notContacted')
            return { bg: 'rgba(245,158,11,.12)', color: 'var(--amber)' };
                                    ...
                                    { label: 'Custom Policies', value: (epData.customLimitPolicies?.length ?? 0) + (epData.customPlatformPolicies?.length ?? 0), color: 'var(--text)', sub: 'Limit + platform overrides' },
                                                ...
                                                { label: 'macOS', r: policy.macOSRestriction },
                                                    ...
                                                    return _jsxs("span", { style: { fontSize: 10, padding: '2px 7px', borderRadius: 4, fontWeight: 700, background: col.bg, color: col.color }, children: [state, ": ", count] }, state);
                                                        ...
                                                        return (_jsxs("tr", { style: { borderBottom: '1px solid var(--border)' }, onMouseEnter: e => { e.currentTarget.style.background = 'var(--navy-light, #1E2D42)'; }, onMouseLeave: e => { e.currentTarget.style.background = ''; }, children: [_jsx("td", { style: { padding: '6px 8px', fontFamily: 'monospace', fontSize: 10 }, children: d.serialNumber || '—' }), _jsx("td", { style: { padding: '6px 8px', color: 'var(--text-dim)' }, children: d.manufacturer || '—' }), _jsx("td", { style: { padding: '6px 8px' }, children: d.model || '—' }), _jsx("td", { style: { padding: '6px 8px', color: 'var(--text-dim)' }, children: d.groupTag || '—' }), _jsx("td", { style: { padding: '6px 8px' }, children: _jsx("span", { style: { fontSize: 10, padding: '2px 6px', borderRadius: 3, fontWeight: 700, background: col.bg, color: col.color }, children: d.enrollmentState }) }), _jsx("td", { style: { padding: '6px 8px', color: 'var(--text-dim)', fontSize: 10 }, children: d.lastContactedDateTime && d.lastContactedDateTime !== '0001-01-01T00:00:00Z' ? new Date(d.lastContactedDateTime).toLocaleDateString() : 'Never' })] }, i));
                                                    }) })] }) }))] }))] }))] }), (runbookText || runbookLoading) && (_jsxs("div", { style: { width: 360, flexShrink: 0, background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 10, padding: 16, display: 'flex', flexDirection: 'column', gap: 12, position: 'sticky', top: 16 }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' }, children: [_jsx("div", { style: { fontSize: 13, fontWeight: 700, color: 'var(--text)' }, children: "\uD83E\uDD16 AI Runbook" }), _jsxs("div", { style: { display: 'flex', gap: 6 }, children: [runbookText && (_jsx("button", { className: "btn btn-secondary", style: { fontSize: 11 }, onClick: () => { navigator.clipboard.writeText(runbookText); addToast('success', 'Copied!'); }, children: "\uD83D\uDCCB Copy" })), _jsx("button", { onClick: () => { setRunbookText(''); setRunbookLoading(false); }, style: { background: 'none', border: 'none', color: 'var(--text-dim)', cursor: 'pointer', fontSize: 18, lineHeight: 1 }, children: "\u00D7" })] })] }), runbookLoading ? (_jsxs("div", { children: [_jsx("div", { className: "skeleton" }), _jsx("div", { className: "skeleton" }), _jsx("div", { className: "skeleton" })] })) : (_jsx("pre", { style: { fontSize: 11, color: 'var(--text-dim)', lineHeight: 1.6, whiteSpace: 'pre-wrap', wordBreak: 'break-word', maxHeight: 520, overflowY: 'auto', margin: 0 }, children: runbookText }))] }))] }));
}
export default function App() {
    ...
    // ── AI Runbook state ─────────────────────────────────────
    const [runbookRow, setRunbookRow] = useState(null);
    ...
    async function loadView(view) {
        ...
        if (view === 'enrollmentPolicy') {
            ...
            setEpError('');
            Promise.all([
                api.get('/graph/enrollment-policy').catch((e) => ({ data: { error: e?.response?.data?.message ?? e?.message } })),
            ]).then(([policyRes]) => {
    ...
    async function executeAction() {
        ...
        try {
            if (action === 'sync')
                ...
                await deviceRetire(deviceId);
            else if (action === 'wipe')
                await deviceWipe(deviceId);
            else if (action === 'collectDiagnostics')
                await deviceCollectDiagnostics(deviceId);
            else if (action === 'rotateBitLockerKeys')
                await deviceRotateBitLockerKeys(deviceId);
            else if (action === 'resetPasscode')
                await deviceResetPasscode(deviceId);
            const labelMap = {
                ...
                return (_jsxs("div", { style: {
                        ...
                        flexWrap: 'wrap', fontFamily: "'DM Mono', monospace", fontSize: 12,
                                ...
                                _jsx("div", { className: "table-wrap", children: filteredRows.length === 0 ? (_jsxs("div", { className: "empty-state", style: { padding: '40px 20px' }, children: [_jsx("div", { className: "empty-state-title", children: "No matching devices" }), _jsx("div", { children: "Try a different search term." })] })) : (_jsxs("table", { className: "data-table data-table-enhanced", children: [_jsx("thead", { children: _jsxs("tr", { children: [isDeviceView && (_jsx("th", { style: { width: 36 }, children: _jsx("input", { type: "checkbox", checked: selectedDevices.size === filteredRows.length && filteredRows.length > 0, onChange: toggleSelectAll, title: "Select all", style: { cursor: 'pointer', accentColor: 'var(--amber)' } }) })), headers.map((header) => (_jsx("th", { children: header.replace(/([A-Z])/g, ' $1').trim() }, header))), _jsx("th", { style: { width: isDeviceView ? 200 : 72 }, children: "Actions" })] }) }), _jsx("tbody", { children: filteredRows.map((row, index) => {
                                    ...
                                    }, children: "\uD83D\uDD11 Authorize Now" })] })] }) })), confirmModal.open && (_jsx("div", { className: "confirm-overlay", onClick: () => setConfirmModal(m => ({ ...m, open: false })), children: _jsxs("div", { className: "confirm-modal", onClick: e => e.stopPropagation(), children: [_jsx("div", { className: "confirm-icon", children: confirmModal.action === 'wipe' ? '🗑️'
                                        ...
                                        : confirmModal.action === 'resetPasscode' ? '📱'
                                            : confirmModal.action === 'collectDiagnostics' ? '📋'
                                                : confirmModal.action?.includes('reset') ? '⚠️'
                                                    : confirmModal.action?.includes('reboot') ? '⚡' : '🔄' }), _jsxs("div", { className: "confirm-title", children: [confirmModal.action === 'sync' && 'Sync Device', confirmModal.action === 'reboot' && 'Reboot Device', confirmModal.action === 'autopilotReset' && 'Autopilot Reset', confirmModal.action === 'retire' && 'Retire Device', confirmModal.action === 'wipe' && 'Wipe Device', confirmModal.action === 'rotateBitLockerKeys' && 'Rotate BitLocker Keys', confirmModal.action === 'resetPasscode' && 'Reset Passcode', confirmModal.action === 'collectDiagnostics' && 'Collect Diagnostics', confirmModal.action === 'bulk-sync' && `Sync ${confirmModal.count} Devices`, confirmModal.action === 'bulk-reboot' && `Reboot ${confirmModal.count} Devices`, confirmModal.action === 'bulk-reset' && `Reset ${confirmModal.count} Devices`] }), _jsx("div", { className: "confirm-body", children: confirmModal.action === 'wipe' ? (_jsxs(_Fragment, { children: [_jsxs("p", { children: ["Are you sure you want to ", _jsx("strong", { children: "WIPE" }), " ", _jsx("span", { className: "confirm-device-name", children: confirmModal.deviceName }), "?"] }), _jsxs("p", { className: "confirm-warning", children: ["\uD83D\uDDD1\uFE0F This will factory reset the device. ", _jsx("strong", { children: "ALL user data will be permanently erased. This cannot be undone." })] })] })) : confirmModal.action === 'retire' ? (_jsxs(_Fragment, { children: [_jsxs("p", { children: ["Retire ", _jsx("span", { className: "confirm-device-name", children: confirmModal.deviceName }), " from Intune management?"] }), _jsx("p", { style: { fontSize: 12, color: 'var(--text-dim)', marginTop: 6 }, children: "The device will be unenrolled on next check-in. User data is preserved." })] })) : confirmModal.action === 'rotateBitLockerKeys' ? (_jsxs("p", { children: ["Rotate BitLocker recovery key for ", _jsx("span", { className: "confirm-device-name", children: confirmModal.deviceName }), "? The new key will be stored in Entra ID."] })) : confirmModal.action === 'resetPasscode' ? (_jsxs(_Fragment, { children: [_jsxs("p", { children: ["Reset passcode on ", _jsx("span", { className: "confirm-device-name", children: confirmModal.deviceName }), "?"] }), _jsx("p", { style: { fontSize: 12, color: 'var(--text-dim)', marginTop: 6 }, children: "The user will need to set a new PIN/passcode on next unlock." })] })) : confirmModal.action === 'collectDiagnostics' ? (_jsxs("p", { children: ["Start diagnostic log collection on ", _jsx("span", { className: "confirm-device-name", children: confirmModal.deviceName }), "? Download the logs from the Intune portal when complete."] })) : confirmModal.action === 'autopilotReset' ? (_jsxs(_Fragment, { children: [_jsxs("p", { children: ["Are you sure you want to ", _jsx("strong", { children: "Autopilot Reset" }), " ", _jsx("span", { className: "confirm-device-name", children: confirmModal.deviceName }), "?"] }), _jsxs("p", { className: "confirm-warning", children: ["\u26A0\uFE0F This will wipe the device and re-run Autopilot provisioning. ", _jsx("strong", { children: "This action cannot be undone." })] })] })) : confirmModal.action === 'bulk-reset' ? (_jsxs(_Fragment, { children: [_jsxs("p", { children: ["Are you sure you want to reset ", _jsxs("strong", { children: [confirmModal.count, " devices"] }), "?"] }), _jsxs("p", { className: "confirm-warning", children: ["\u26A0\uFE0F All selected devices will be wiped. ", _jsx("strong", { children: "This action cannot be undone." })] })] })) : confirmModal.action === 'reboot' ? (_jsxs("p", { children: ["Reboot ", _jsx("span", { className: "confirm-device-name", children: confirmModal.deviceName }), "? The device will restart immediately."] })) : confirmModal.action === 'bulk-reboot' ? (_jsxs("p", { children: ["Reboot ", _jsxs("strong", { children: [confirmModal.count, " devices"] }), "? All selected devices will restart."] })) : confirmModal.action === 'bulk-sync' ? (_jsxs("p", { children: ["Force policy sync on ", _jsxs("strong", { children: [confirmModal.count, " devices"] }), "?"] })) : (_jsxs("p", { children: ["Force policy sync on ", _jsx("span", { className: "confirm-device-name", children: confirmModal.deviceName }), "?"] })) }), _jsxs("div", { className: "confirm-actions", children: [_jsx("button", { className: "btn btn-secondary", onClick: () => setConfirmModal(m => ({ ...m, open: false })), children: "Cancel" }), _jsx("button", { className: `btn ${['wipe', 'autopilotReset', 'bulk-reset'].includes(confirmModal.action ?? '') ? 'btn-danger' : 'btn-primary'}`, onClick: executeAction, children: confirmModal.action === 'sync' || confirmModal.action === 'bulk-sync' ? '🔄 Confirm Sync'
