...
export declare function getExportUrl(view: string, format: 'json' | 'csv'): string;
export declare function getIncidentWorkflows(): Promise<{
    rows: IncidentWorkflowRecord[];
}>;
export declare function saveIncidentWorkflow(signature: string, payload: {
    owner: string;
