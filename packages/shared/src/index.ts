...
export type IncidentWorkflowStatus = 'New' | 'Investigating' | 'Mitigating' | 'Resolved';
...
export type IncidentSlaState = 'Healthy' | 'AtRisk' | 'Breached';
...
export interface ExecutiveFailureCause {
  title: string;
  category: string;
  impacted: number;
}
...
export interface ExecutiveSummary {
  ...
  slaBreached: number;
  slaAtRisk: number;
  topFailureCauses: ExecutiveFailureCause[];
}
